...
-- lua版本性能较低, 100次耗时1.0699999332428s:
--    local sha256 = require "sha256"
--    local bodystr = '{"app_id":"z.global.prod","role_unique_id":"7a23f600cf454a398b8b5a885e20616d","account_id":"fp_account_global:10004"}'
--    for i=1,100 do
--        local hash = sha256.hmac_sha256("c058f958-10f0-499a-872d-c3e8e1348474", bodystr)
--    end
--c版本性能高, 100次耗时0.01s, 推荐使用:
--	  local lhmac_sha256 = require "lhmac_sha256"
--    local bodystr = '{"app_id":"z.global.prod","role_unique_id":"7a23f600cf454a398b8b5a885e20616d","account_id":"fp_account_global:10004"}'
--    for i=1,100 do
--	  	local hash = lhmac_sha256.hmac_sha256_hex(svrconf.app_server_secret, bodystr)
--    end
local sha256 = { }
